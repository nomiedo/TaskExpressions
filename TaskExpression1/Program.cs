...
namespace TaskExpression1
{
        ...
        public static class MappingGenerator
    {
        ...
        {
            public static readonly Func<TInput, TOutput> Instance = MappingGenerator.CreateMapFunc<TInput, TOutput>();
        }
        public struct Unit<T>
        {
            ...
            public U MapTo<U>()
            {
                return MapFunc<T, U>.Instance(Value);
            }
        }
    ...
    class Program
        {
            ...
            {
                Foo2 obj = new Foo2 { Bar = "My Name", Baz = "Some other data" };
